...
private:
    ...
    std::shared_ptr<blinglog::logger> console_logger_;
    std::shared_ptr<blinglog::async_logger> async_file_logger_;
    std::shared_ptr<blinglog::logger> sync_file_logger_;
...
using blinglogger = blinglog::logger_manager;
