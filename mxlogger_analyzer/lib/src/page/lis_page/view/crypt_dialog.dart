...
class _CryptDialogState extends State<CryptDialog> {
 ...
 late TextEditingController _aesIvController;
  ...
  void initState() {
    ...
    super.initState();
    _aesKeyController = TextEditingController(text: MXLoggerStorage.instance.cryptKey);
    _aesIvController = TextEditingController(text: MXLoggerStorage.instance.cryptIv);
  }
  ...
  Widget build(BuildContext context) {
    return CupertinoAlertDialog(
      ...
      actions: [
        CupertinoDialogAction(child: const Text("确定"),onPressed: () async{

         await MXLoggerStorage.instance.saveAES(cryptKey: _aesKeyController.text,iv: _aesIvController.text);
